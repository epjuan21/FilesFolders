...
namespace FilesFolders.Clases
{
    internal class Correcciones
    {
            ...
            var ambitoMap = new Dictionary<string, string>
                    {
                        ...
                        { "907", "1" }, { "908", "1" }, { "931", "1" }, { "936", "1" },
                        { "950", "1" }, { "911", "1" }, { "935", "1" },
                        { "993", "1" }, { "963", "1" }, { "973", "1" },
                        { "981", "3" }, { "982", "3" }, { "990", "1" }, { "992", "1" },
                        { "995", "1" }, { "997", "1" }
                    };
        ...
        public string CorregirCUMMedicamento(ref string line, int codigoCUMPos, string Entidad = "")
        {
            ...
            // GLICERINA
            if (codigoCUM == "1-2" && Entidad == "SSSA")
            {
                codigoCUMCorregido = "20003817-4";
            }

            // RETIBLAN
            if (codigoCUM == "19904368-9" && Entidad == "SSSA")
            {
                codigoCUMCorregido = "19900780-1";
            }
